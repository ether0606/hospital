...
function Designation() {
    ...
    function getDatas() {
        axios.get(`http://localhost/hms_api/designation.php`).then(function(response) {
            setData(response.data);
        });
    }
    const deleteData = (id) => {
        axios.post(`http://localhost/hms_api/designation_delete.php`,{id:id}).then(function(response){
            getDatas();
        });
    }
  return (
